...
@Configuration
public class EventSubscriberConfig implements ApplicationListener<ApplicationReadyEvent> {

  private Logger logger = LoggerFactory.getLogger(EventSubscriberConfig.class);
